...
func TestCreateOrderSeparatesRouteEstimatePriceAndPersistence(t *testing.T) {
	...
	warehouses := []models.Warehouse{
		{ID: uuid.New(), Name: "Origin", Address: "Origin address", City: "Test", Latitude: 60, Longitude: 30, CreatedAt: time.Now()},
		{ID: uuid.New(), Name: "Destination", Address: "Destination address", City: "Test", Latitude: 61, Longitude: 31, CreatedAt: time.Now()},
	}
	...
	if result.Order.TotalPrice != 188 || result.Route.DistanceKm != 25 || result.Route.DurationSec != 900 {
	...
	if err != nil || storedOrder.TotalPrice != 188 {
	...
	if err != nil || storedRoute.DistanceKm != 25 {
	...
	if err != nil || updated.TotalPrice != 218 {
